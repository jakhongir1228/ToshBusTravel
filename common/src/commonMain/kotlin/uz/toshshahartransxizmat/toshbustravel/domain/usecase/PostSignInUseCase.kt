...
typealias PostSingInBaseUseCase = BaseUseCase<SignInEntity, Flow<AuthResponseData>>

class PostSignInUseCase: KoinComponent, PostSingInBaseUseCase {

    private val repository: NetworkRepository by inject()

    override suspend fun invoke(parameter: SignInEntity): Flow<AuthResponseData> {
